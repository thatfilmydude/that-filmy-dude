export default function ArticleCard(props) {
  ...
  return (
    <article>
      <div className={"relative rounded-lg mb-4 flex items-end " + slateHeight}
        style={{
          backgroundImage: "repeating-linear-gradient(45deg, rgba(28,20,22,0.9) 0 26px, rgba(28,20,22,0.78) 26px 52px)"
        }}>
      ...
      <span className="block font-mono text-[11px] tracking-widest uppercase text-branddark mb-2">
        {props.kicker}
      </span>
      <h3 className={"font-display leading-tight text-[#1C1416] mb-2 " + titleSize}>
        {props.title}
      </h3>
