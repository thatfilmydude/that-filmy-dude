export default function ArticleCard(props) {
  ...
  return (
    <a href={"/articles/" + props.slug} className="block">
      <div className={"relative rounded-lg mb-4 flex items-end " + slateHeight} style={{ backgroundImage: "repeating-linear-gradient(45deg, rgba(28,20,22,0.9) 0 26px, rgba(28,20,22,0.78) 26px 52px)" }}>
